...
/**
 * Color palette for MedSupply Guardian application.
 *
 * This file defines the Material Design 3 color scheme with a healthcare-focused
 * palette using Medical Blue as primary and Healthcare Teal as secondary.
 * Colors are optimized for accessibility and medical industry standards.
 *
 * Primary Color: Medical Blue (#0066CC) - Conveys trust and professionalism
 * Secondary Color: Healthcare Teal (#00897B) - Complements primary while maintaining clarity
 *
 * @author Gustavo Sanchez
 */

val md_theme_light_primary = Color(0xFF415E91)
...
val md_theme_light_secondaryContainer = Color(0xFF75F8E5)
...
val md_theme_dark_inversePrimary = Color(0xFF415E91)
